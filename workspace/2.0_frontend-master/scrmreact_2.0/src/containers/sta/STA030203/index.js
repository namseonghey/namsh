			...
			<React.Fragment>
				...
				<RelativeGroup>
					<RFloatArea>
						...
						/>
						<Label value={this.state.imageCfnIndex + " / " + this.state.imageCfnTotal}/>
						<Button
							id = {'imgCfnRight'}
							value = {'▶'}
							onClick = {this.event.button.onClick}
				...
				<RelativeGroup>
					<RFloatArea>
						<Button
							id       = {this.state.btnProps.btnCfnAddFile.id}
							value    = {this.state.btnProps.btnCfnAddFile.value}
							disabled = {this.state.btnProps.btnCfnAddFile.disabled}
							hidden   = {this.state.btnProps.btnCfnAddFile.hidden}
							onClick  = {this.event.button.onClick}
							mt       = {5}
						/>
						<Button
							id       = {this.state.btnProps.btnCfnDelFile.id}
							value    = {this.state.btnProps.btnCfnDelFile.value}
							disabled = {this.state.btnProps.btnCfnDelFile.disabled}
							hidden   = {this.state.btnProps.btnCfnDelFile.hidden}
							onClick  = {this.event.button.onClick}
							mt       = {5}
						/>
						<Button
							id       = {this.state.btnProps.btnCfnSave.id}
							value    = {this.state.btnProps.btnCfnSave.value}
							disabled = {this.state.btnProps.btnCfnSave.disabled}
							hidden   = {this.state.btnProps.btnCfnSave.hidden}
							onClick  = {this.event.button.onClick}
							mt       = {5}
						/>
					</RFloatArea>
